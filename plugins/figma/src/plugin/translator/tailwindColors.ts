/** Tailwind-style color scales (hex) — used for bg-/text- utilities. */
...
export const ZINC: Record<number, string> = {
  50: "#fafafa",
  100: "#f4f4f5",
  200: "#e4e4e7",
  300: "#d4d4d8",
...
export const STONE: Record<number, string> = {
  50: "#fafaf9",
  100: "#f5f5f4",
  200: "#e7e5e4",
  300: "#d6d3d1",
...
export const ORANGE: Record<number, string> = {
  50: "#fff7ed",
  100: "#ffedd5",
  200: "#fed7aa",
  300: "#fdba74",
...
export const EMERALD: Record<number, string> = {
  50: "#ecfdf5",
  100: "#d1fae5",
  200: "#a7f3d0",
  300: "#6ee7b7",
...
export const VIOLET: Record<number, string> = {
  50: "#f5f3ff",
  100: "#ede9fe",
  200: "#ddd6fe",
  300: "#c4b5fd",
...
export const ROSE: Record<number, string> = {
  50: "#fff1f2",
  100: "#ffe4e6",
  200: "#fecdd3",
  300: "#fda4af",
...
/** Name → scale for bg-/text- palette utilities */
